...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_size', type=int, default=7936) #327680
    ...
    # raw_dataset = load_dataset("AGundawar/countdown", "countdown_n4", split='train')
    if data_source=='countdown4':
