...
def compute_advantage(data: DataProto, adv_estimator, gamma=1.0, lam=1.0, num_repeat=1, use_grpo_simplified=False,
                                                                        alpha=0.0):
    ...
    if adv_estimator == 'gae':
        ...
        advantages, returns = core_algos.compute_grpo_outcome_advantage(token_level_rewards=token_level_rewards,
                                                                        eos_mask=response_mask,
                                                                        index=index,
                                                                        use_grpo_simplified=use_grpo_simplified,
                                                                        alpha=alpha)
        data.batch['advantages'] = advantages
        data.batch['returns'] = returns
    else:
...
class RayPPOTrainer(object):
    ...
    def _save_checkpoint(self):
        ...
        # # storing wandb run id
        local_latest_wandb_run_id = os.path.join(self.config.trainer.default_local_dir,
                                                           'latest_checkpointed_wandb_run_id.txt')
                ...
                with _timer('step', timing_raw):
                    ...
                    with _timer('adv', timing_raw):
                        ...
                        batch = compute_advantage(batch,
                                                  ...
                                                  use_grpo_simplified=self.config.algorithm.use_grpo_simplified,
